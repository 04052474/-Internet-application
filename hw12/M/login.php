...
if(!isset($_SESSION["loginMember"]) || ($_SESSION["loginMember"]=="")){
	if(isset($_POST["username"]) && isset($_POST["passwd"])){
		...
		//選取儲存帳號密碼的資料表
		 ...
		 $sqlget = mysql_query($sqladmin);
		 $row_result=mysql_fetch_assoc($sqlget);
		//取出帳號密碼的值
  ...
  <tr>
    <td><table align="left" border="0" cellpadding="0" cellspacing="0" width="700">
        <tr>
          ...
          <td align="center" valign="top" background="images/botbg.jpg" class="trademark">© 2014 eHappy Studio All Rights Reserved. </td>
