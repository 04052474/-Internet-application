  ...
  <tr>
    <td background="images/admin_r3_c1.jpg"><div id="mainRegion">
       ...
       <table width="90%" border="0" align="center" cellpadding="4" cellspacing="0">
		...
		<table width="90%" border="0" align="center" cellpadding="4" cellspacing="0">
          <tr valign="top">
		  <?php if($row_result["boardsex"]=="女"){?>
            <td width="60" align="center" class="underline"> <img src="images/female.gif" alt="我是女生" width="49" height="49">
		<?php } ?>
		<?php if($row_result["boardsex"]=="男"){?>
            <td width="60" align="center" class="underline"> <img src="images/male.gif" alt="我是男生" width="49" height="49">
		<?php } ?>
			   <br>
              <span class="postname"><?php echo $row_result["boardname"];?></span></td>
            <td class="underline"><span class="smalltext">[<?php echo $row_result["boardid"];?>]
			
			</span><span class="heading"> <?php echo $row_result["boardsubject"];?>
			<a href='adminfix.php?id=<?php echo $row_result[boardid];?>'>[修改]</a>
			<a href='admindel.php?id=<?php echo $row_result[boardid];?>'>[刪除]</a></span>
			
              <p><?php echo $row_result["boardcontent"];?></p>
              <p align="right" class="smalltext"><?php echo $row_result["boardtime"];?>
				<?php if($row_result["boardmail"]!=""){?>
			  <a href=<?php echo $row_result["boardmail"];?>><img src="images/email-a.png" alt="電子郵件" width="16" height="16" border="0" align="absmiddle"></a>
                <?php } ?>
				<?php if($row_result["boardweb"]!=""){?>
			  <a href=<?php echo $row_result["boardweb"];?>><img src="images/home-a.png" alt="個人網站" width="16" height="16" border="0" align="absmiddle"></a>
                <?php } ?>
				</p></td>
          </tr>          
        </table>
