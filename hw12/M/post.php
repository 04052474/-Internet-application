...
if(isset($_POST["action"])&&($_POST["action"]=="add")){
	...
	$dt = new DateTime();
	$wantdate=$dt->format('Y-m-d H:i:s');
	$addbook="INSERT INTO `board` (`boardsubject`,`boardname`,`boardsex`,`boardmail`,`boardweb`,`boardcontent`,`boardtime`) VALUE ('$_POST[boardsubject]'
	,'$_POST[boardname]','$_POST[boardsex]','$_POST[boardmail]','$_POST[boardweb]','$_POST[boardcontent]','$wantdate')";
	mysql_query($addbook);
	//重新導向回到主畫面
          ...
          <table width="90%" border="0" align="center" cellpadding="4" cellspacing="0">
            <tr valign="top">
              ...
              <td><p>標題
                ...
                <p>性別
                  <input name="boardsex" type="radio" id="radio" value="男" checked>
                  男
                  <input type="radio" name="boardsex" id="radio2" value="女">
                  女</p>
                <p>郵件
