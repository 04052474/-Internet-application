  ...
  <tr>
    <td background="images/board_r3_c1.jpg"><div id="mainRegion">
		...
		<?php } ?>
            ...
            <td class="underline"><span class="smalltext">[<?php echo $row_result["boardid"];?>]</span><span class="heading"> <?php echo $row_result["boardsubject"];?></span>
        ...
        <table width="90%" border="0" align="center" cellpadding="4" cellspacing="0">
          <tr>
            <td valign="middle"><p>資料筆數：<?php echo $total_records;?></p></td> <!-- 有改 -->
            <td align="right"><p>
