		...
		<table width="90%" border="0" align="center" cellpadding="4" cellspacing="0">
          <tr valign="top">
            <td width="60" align="center" class="underline"> <img src="images/female.gif" alt="我是女生" width="49" height="49">
               <br>
              <span class="postname">Lily</span></td>
            <td class="underline"><span class="smalltext">[2]</span><span class="heading"> <?php echo $row_result["boardsubject"]?></span>
              <p>我也很喜歡這個留言版！</p>
              <p align="right" class="smalltext">2008-10-16 11:27:30                                <a href="mailto:lily@e-happy.com.tw"><img src="images/email-a.png" alt="電子郵件" width="16" height="16" border="0" align="absmiddle"></a>
                                              </p></td>
          </tr>          
        </table>
		<?php } ?>
